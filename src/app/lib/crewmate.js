// https://github.com/influenceth/sdk/blob/master/src/lib/crewmate.js

const CLASSES = {
  0: {
    name: "Undecided",
    description: "Currently going through assignment...",
  },
  1: {
    name: "Pilot",
    description:
...
const TITLES = {
  ...
  1: {
    ...
    department: DEPARTMENT_IDS.NAVIGATION,
    tier: 1,
  },
  2: {
    name: "Teaching Assistant",
    department: DEPARTMENT_IDS.EDUCATION,
    tier: 1,
  },
  ...
  5: {
    ...
    department: DEPARTMENT_IDS.SECURITY,
    tier: 1,
  },
  6: {
    name: "Warehouse Worker",
    department: DEPARTMENT_IDS.LOGISTICS,
    tier: 1,
  },
  7: {
    name: "Maintenance Technician",
    department: DEPARTMENT_IDS.MAINTENANCE,
    tier: 1,
  },
  8: {
    name: "Systems Administrator",
    department: DEPARTMENT_IDS.TECHNOLOGY,
    tier: 1,
  },
  9: {
    name: "Structural Engineer",
    department: DEPARTMENT_IDS.ENGINEERING,
    tier: 1,
  },
  10: { name: "Farmer", department: DEPARTMENT_IDS.FOOD_PRODUCTION, tier: 1 },
  11: {
    name: "Line Cook",
    department: DEPARTMENT_IDS.FOOD_PREPARATION,
    tier: 1,
  },
  12: {
    name: "Artist",
    department: DEPARTMENT_IDS.ARTS_ENTERTAINMENT,
    tier: 1,
  },
  13: { name: "Block Captain", department: DEPARTMENT_IDS.MANAGEMENT, tier: 1 },
  14: {
    name: "Observatory Technician",
    department: DEPARTMENT_IDS.NAVIGATION,
    tier: 2,
  },
  ...
  17: {
    ...
    department: DEPARTMENT_IDS.MEDICINE,
    tier: 2,
  },
  18: {
  ...
  22: {
    name: "Life Support Engineer",
    department: DEPARTMENT_IDS.ENGINEERING,
    tier: 2,
  },
  23: {
    name: "Field Botanist",
    department: DEPARTMENT_IDS.FOOD_PRODUCTION,
    tier: 2,
  },
  24: {
    name: "Section Cook",
  ...
  55: {
    ...
    department: DEPARTMENT_IDS.KNOWLEDGE,
    tier: 5,
  },
  56: {
  ...
  65: {
    name: "High Commander",
    department: DEPARTMENT_IDS.MANAGEMENT,
    tier: 5,
  },
...
const TRAITS = {
  1: {
    name: "Drive: Survival",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You need to live. Your primary drive is the survival of yourself, the people you know, and the species.",
  },
  2: {
    name: "Drive: Service",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You need to fulfill your role. Your primary drive is to serve humanity for the greater good.",
  },
  3: {
    name: "Drive: Glory",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You need to excel. Your primary drive is to be the best at whatever you do.",
  },
  4: {
    name: "Drive: Command",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You need to be in control. Your primary drive is to lead others in what you know to be the right direction.",
  },
  5: {
    name: "Adventurous",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You are bold, brave, and intrepid. You recognize that in order to move humanity forward, it is sometimes necessary to take that giant leap for mankind.",
  },
  6: {
    name: "Ambitious",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You know what needs to be done, and you know that you are the one who can do it. You are driven to succeed, no matter the obstacles.",
  },
  7: {
    name: "Arrogant",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "Hubris may have been the downfall of lesser people, but you are steadfastly confident in your own abilities. Let other people be led around by those stronger than themselves, you know what you are capable of.",
  },
  8: {
    name: "Cautious",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "Let others leap before they look. You will stay with what you know works, until there is some proof that another course is safer.",
  },
  9: {
    name: "Creative",
    type: TRAIT_TYPES.COSMETIC,
    description:
      'You seek to bring new ideas to light. Your mind is constantly wandering to the question "what if..." You want to see if you can explain the "unexplainable".',
  },
  10: {
    name: "Curious",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You are excited to open your mind and learn something new. The universe is full of the undiscovered just waiting to be discovered.",
  },
  11: {
    name: "Fierce",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You are a forceful person who is drawn to intensity. You have strong convictions and seek out others who do as well.",
  },
  12: {
    name: "Flexible",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You are open-minded and able to quickly analyze new ideas. You are not stuck in the past and are always ready to respond to new challenges.",
  },
  13: {
    name: "Frantic",
    type: TRAIT_TYPES.COSMETIC,
  ...
  14: {
    ...
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You know the risks, you understand the downsides, but you just can't help your optimism. Besides, when has humanity ever truly expanded its abilities except when it held onto hope in the face of adversity?",
  },
  15: {
    name: "Independent",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You are free-thinking and not prone to blindly following orders, unless there is a very good explanation behind those orders.",
  },
  16: {
    name: "Irrational",
    type: TRAIT_TYPES.COSMETIC,
    description:
      'You don\'t waste your time with logic, at least not the type that makes sense to anyone else. You have never had the dubious honor of being called "reasonable."',
  },
  17: {
    name: "Loyal",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You understand the importance of staying the course and trusting those around you to make rational decisions.",
  },
  18: {
    name: "Pragmatic",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "Instead of wasting time wishing for a better reality, you are firmly rooted in your present situation. You prefer to find the most practical solution to a problem, even if it isn't always the most desirable.",
  },
  19: {
    name: "Rational",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You try not to let messy emotions cloud your thinking. Logic is the only reliable constant in the universe.",
  },
  20: {
    name: "Reckless",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You believe that anyone who takes life too seriously will never know its true enjoyment. Meticulous plans and detailed outcome calculations are for others to worry about.",
  },
  21: {
    name: "Regressive",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You look to the past and rely on what others have built or imagined. You prefer to rely upon what is tried and true, rather than innovate yourself into a disaster.",
  },
  22: {
    name: "Serious",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You have no time for self-indulgent nonsense. You understand your role and responsibilities in the universe and you wish that others understood theirs.",
  },
  23: {
    name: "Steadfast",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You are firm in your beliefs and prefer to rely on what is known, rather than dream about what could be. You believe that experience is the best teacher.",
  },
  24: {
    name: "Council Loyalist",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You are loyal to the Prime Council and the last High Commander of the Arvad. ",
  },
  25: {
    name: "Council Moderate",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You believe that there is no better alternative to the Prime Council and the last High Commander of the Arvad. ",
  },
  26: {
    name: "Independent Moderate",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You are critical of the leadership of the Prime Council and the last High Commander of the Arvad.",
  },
  27: {
    name: "Independent Radical",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You openly oppose the leadership of the Prime Council or the last High Commander of the Arvad. ",
  },
  28: {
    name: "Navigator",
    type: TRAIT_TYPES.IMPACTFUL,
    description: "You have 2% increased propellant velocity.",
  },
  29: {
    name: "Dietitian",
    type: TRAIT_TYPES.IMPACTFUL,
    description: "You have 10% decreased food consumption rate for your crew.",
  },
  30: {
    name: "Refiner",
    type: TRAIT_TYPES.IMPACTFUL,
    description:
      "You have 5% increased refining speed while refining materials.",
  },
  31: {
    name: "Surveyor",
    type: TRAIT_TYPES.IMPACTFUL,
    description:
      "You have 10% increased core sampling speed while surveying an asteroid.",
  },
  32: {
    name: "Hauler",
    type: TRAIT_TYPES.IMPACTFUL,
    description: "You have 5% increased inventory mass capacity.",
  },
  33: {
    name: "Optimistic",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You know that no matter how dark it may seem now, dawn is just over the horizon.",
  },
  34: {
    name: "Thoughtful",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You are not quick to choose. You often prefer to wait for more information before committing yourself.",
  },
  35: {
    name: "Pessimistic",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You see no point in trying to fool yourself or anyone else. You often expect the worst and are rarely surprised by reality.",
  },
  36: {
    name: "Righteous",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You believe that you are virtuous and hold others to a high moral standard.",
  },
  37: {
    name: "Communal",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You believe in community and cooperation. We can all succeed, if we work together.",
  },
  38: {
    name: "Impartial",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You are capable of viewing many issues without bias or prejudice.",
  },
  39: {
    name: "Enterprising",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You are resourceful and able to build on the ideas of others.",
  },
  40: {
    name: "Opportunistic",
    type: TRAIT_TYPES.COSMETIC,
    description:
      "You believe in taking advantage of being in the right place at the right time.",
  },
  41: {
    name: "Buster",
    type: TRAIT_TYPES.IMPACTFUL,
    description: "You have 2% increased propellant flow rate.",
  },
  42: {
    name: "Mogul",
    type: TRAIT_TYPES.IMPACTFUL,
    description: "You have 16% increased fee enforcement on market orders.",
  },
  43: {
    name: "Scholar",
    type: TRAIT_TYPES.IMPACTFUL,
  ...
  44: {
    name: "Recycler",
    type: TRAIT_TYPES.IMPACTFUL,
    description: "You have 10% decreased loss when deconstructing buildings.",
  },
  45: {
    name: "Mechanic",
    type: TRAIT_TYPES.IMPACTFUL,
  ...
  47: {
    name: "Logistician",
    type: TRAIT_TYPES.IMPACTFUL,
    description: "You have 5% increased surface transport speed.",
  },
  48: {
    name: "Experimenter",
    type: TRAIT_TYPES.IMPACTFUL,
  ...
  49: {
    name: "Builder",
    type: TRAIT_TYPES.IMPACTFUL,
    description: "You have 5% increased building construction speed.",
  },
  50: {
    name: "Prospector",
    type: TRAIT_TYPES.IMPACTFUL,
    description: "You have 5% increased core sample quality.",
  },
};
 ...
 */
const getCombinedTraits = (crewmate) =>
  [...(crewmate.impactful || []), ...(crewmate.cosmetic || [])].sort();
Component.getCombinedTraits = getCombinedTraits;
Entity.getCombinedTraits = (entity) =>
  Component.getCombinedTraits(entity.Crewmate);
...
Component.unpackAppearance = (crewmate) =>
  unpackAppearance(crewmate.appearance);
Entity.unpackAppearance = (entity) =>
  Component.unpackAppearance(entity.Crewmate);
...
Component.getItem = (crewmate) =>
  getItem(unpackAppearance(crewmate.appearance).item);
...
Component.getFace = (crewmate) =>
  getFace(unpackAppearance(crewmate.appearance).face);
...
Component.getGender = (crewmate) =>
  getGender(unpackAppearance(crewmate.appearance).gender);
...
Component.getHairColor = (crewmate) =>
  getHairColor(unpackAppearance(crewmate.appearance).hairColor);
...
Component.getHair = (crewmate) =>
  getHair(unpackAppearance(crewmate.appearance).hair);
...
Component.getHead = (crewmate) =>
  getHead(unpackAppearance(crewmate.appearance).head);
...
Component.getClothes = (crewmate) =>
  getClothes(unpackAppearance(crewmate.appearance).clothes);
...
const nextArvadianTraits = (crewmateClass = null, traits = []) => {
  ...
  if (traits.length === 0) {
    validTraits = [
      TRAIT_IDS.DRIVE_SURVIVAL,
      TRAIT_IDS.DRIVE_SERVICE,
      TRAIT_IDS.DRIVE_GLORY,
      TRAIT_IDS.DRIVE_COMMAND,
    ];
    ...
    if (
      traits[0] === TRAIT_IDS.DRIVE_SURVIVAL &&
      forSurvival.includes(traits[1])
    )
      validTraits.splice(0, 1);
    if (traits[0] === TRAIT_IDS.DRIVE_SERVICE && forService.includes(traits[1]))
      validTraits.splice(0, 1);
    if (traits[0] === TRAIT_IDS.DRIVE_GLORY && forGlory.includes(traits[1]))
      validTraits.splice(3, 1);
    if (traits[0] === TRAIT_IDS.DRIVE_COMMAND && forCommand.includes(traits[1]))
      validTraits.splice(3, 1);
    ...
    validTraits = [
      TRAIT_IDS.OPTIMISTIC,
      TRAIT_IDS.THOUGHTFUL,
      TRAIT_IDS.PESSIMISTIC,
    ];
  } else if (traits.length === 5) {
    const councilLoyalist = [
      TRAIT_IDS.RIGHTEOUS,
      TRAIT_IDS.COMMUNAL,
      TRAIT_IDS.IMPARTIAL,
    ];
    const councilModerate = [
      TRAIT_IDS.RIGHTEOUS,
      TRAIT_IDS.COMMUNAL,
      TRAIT_IDS.IMPARTIAL,
    ...
    if (crewmateClass === CLASS_IDS.PILOT) {
      ...
      validTraits.push(
        traits[6] === TRAIT_IDS.OPERATOR ? TRAIT_IDS.BUSTER : TRAIT_IDS.OPERATOR
      );
    } else if (crewmateClass === CLASS_IDS.ENGINEER) {
      validTraits = [TRAIT_IDS.LOGISTICIAN, TRAIT_IDS.OPERATOR];
      validTraits.push(
        traits[6] === TRAIT_IDS.BUILDER ? TRAIT_IDS.MECHANIC : TRAIT_IDS.BUILDER
      );
    } else if (crewmateClass === CLASS_IDS.MINER) {
      validTraits = [TRAIT_IDS.OPERATOR, TRAIT_IDS.EXPERIMENTER];
      validTraits.push(
        traits[6] === TRAIT_IDS.PROSPECTOR
          ? TRAIT_IDS.RECYCLER
          : TRAIT_IDS.PROSPECTOR
      );
    } else if (crewmateClass === CLASS_IDS.MERCHANT) {
      ...
      validTraits.push(
        traits[6] === TRAIT_IDS.LOGISTICIAN
          ? TRAIT_IDS.MOGUL
          : TRAIT_IDS.LOGISTICIAN
      );
    } else if (crewmateClass === CLASS_IDS.SCIENTIST) {
      ...
      validTraits.push(
        traits[6] === TRAIT_IDS.EXPERIMENTER
          ? TRAIT_IDS.SCHOLAR
          : TRAIT_IDS.EXPERIMENTER
      );
    }
...
const nextAdalianTraits = (crewmateClass, traits) => {
  ...
  if (traits.length === 0) {
    ...
    if (crewmateClass === CLASS_IDS.PILOT)
      validTraits = [TRAIT_IDS.NAVIGATOR, TRAIT_IDS.BUSTER, TRAIT_IDS.OPERATOR];
    if (crewmateClass === CLASS_IDS.ENGINEER)
      validTraits = [TRAIT_IDS.REFINER, TRAIT_IDS.MECHANIC, TRAIT_IDS.BUILDER];
    if (crewmateClass === CLASS_IDS.MINER)
      validTraits = [
        TRAIT_IDS.SURVEYOR,
        TRAIT_IDS.RECYCLER,
        TRAIT_IDS.PROSPECTOR,
      ];
    if (crewmateClass === CLASS_IDS.MERCHANT)
      validTraits = [TRAIT_IDS.HAULER, TRAIT_IDS.MOGUL, TRAIT_IDS.LOGISTICIAN];
    if (crewmateClass === CLASS_IDS.SCIENTIST)
      validTraits = [
        TRAIT_IDS.DIETITIAN,
        TRAIT_IDS.SCHOLAR,
        TRAIT_IDS.EXPERIMENTER,
